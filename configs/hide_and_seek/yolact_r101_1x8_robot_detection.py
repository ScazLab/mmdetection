...
data_root = '/home/debasmita/catkin_ws/src/hide_and_seek/hr_hide_seek/data/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        img_prefix=data_root + 'robot_detection_images/all_images',
        classes=classes,
        ann_file=data_root + 'robot_detection_annotations/coco_json_heading_all.json',
...
work_dir = '/home/debasmita/catkin_ws/src/hide_and_seek/hr_hide_seek/models/robot_detection/'
